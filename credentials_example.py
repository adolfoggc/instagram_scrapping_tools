#Hi!
#You need to copy or rename this file to 'credentials.py' and change it's configuration

#your instagram login and password
login = 'login'
password = 'PASSWORD'
...
#ABOUT PROFILE
profile_info_xpath = '/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div/header/section'
